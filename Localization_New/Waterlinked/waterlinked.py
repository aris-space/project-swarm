...
waterlinked_instance = WaterLinked(base_url="http://192.168.8.108", poll_interval=1.0, test_mode=False)
while True:
    print(waterlinked_instance.get_latest_position(timeout=2.0))
