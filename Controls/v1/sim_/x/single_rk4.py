...
def simple_rk4 (vehicle_model, y, u_prev, u_new, sim_freq):

    dt = 1/sim_freq

    k1 = dt * vehicle_model(y, u_prev)
    k2 = dt * vehicle_model(y, u_prev)
    k3 = dt * vehicle_model(y, u_prev)
    k4 = dt * vehicle_model(y, u_new)

    return y + (dt / 6) * (k1 + 2 * k2 + 2 * k3 + k4)

def advanced_rk4(vehicle_model, y, u_prev, u_new, sim_freq):
